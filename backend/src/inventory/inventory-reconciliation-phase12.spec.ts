...
describe('Phase 12 - Inventory Reconciliation', () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: getRepositoryToken(InventoryItem), useValue: {} },
        {
          ...
          useValue: { createQueryBuilder: () => balanceQueryBuilder },
        },
        {
          provide: getRepositoryToken(StockTransaction),
          useValue: { createQueryBuilder: () => txQueryBuilder },
        },
  ...
  it('Test 13: Missing opening balance => NOT_RECONCILABLE', async () => {
    setupMocks([{ id: 'b1', currentQuantity: '10' }], []);
    const res = await service.getReconciliation();
  ...
  it('Test 15: Multi-warehouse aggregation', async () => {
    setupMocks(
      ...
      [
        {
          productId: 'p1',
          destinationBinId: 'WH1_BIN1',
          type: TransactionType.STOCK_IN,
          total: '5',
        },
        {
          productId: 'p1',
          destinationBinId: 'WH2_BIN1',
          type: TransactionType.STOCK_IN,
          total: '5',
        },
      ],
