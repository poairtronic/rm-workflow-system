...
> = {
  ...
  SENIOR_VERIFIED: { label: 'Senior Verified', symbol: '✓', badgeClass: 'badge-verified' },
  STORES_PENDING: { label: 'Pending Stores', symbol: '!', badgeClass: 'badge-pending' },
  PARTIALLY_ISSUED: { label: 'Partially Issued', symbol: '⚠', badgeClass: 'badge-partial' },
  ...
  ADDITIONAL_REQUEST: { label: 'Additional Request', symbol: '↻', badgeClass: 'badge-additional' },
